...
public class BaseDialog extends Dialog implements View.OnClickListener {
    ...
    private RelativeLayout mLayoutTitle;     // 标题根布局
    ...
    private View line;             //button2的竖线
    private View bottomLine;       //button2的竖线
    ...
    private void initViews() {
        ...
        mLayoutRoot.setBackground(SelectorUtil.getShape(Color.WHITE, 2, 0, Color.WHITE));
        ...
        line = findViewById(R.id.view_dialog_two);
