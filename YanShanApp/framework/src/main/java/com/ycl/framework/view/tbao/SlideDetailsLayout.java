package com.ycl.framework.view.tbao;
...
/**
 * Created by yuchaoliang on 16/12/29.
 */
...
public class SlideDetailsLayout extends ViewGroup {
        ...
        switch (aciton) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (canChildScrollVertically((int) yDiff)) {
                    shouldIntercept = false;
                    YisLoger.logTag(TAG,"intercept, child can scroll vertically, do not intercept");
                } else {
                    ...
                    if (yDiffabs > mTouchSlop && yDiffabs >= xDiffabs
                        ...
                        YisLoger.logTag(TAG, "intercept, intercept events");
                    }
                }
                break;
            }
    ...
    private void processTouchEvent(final float offset) {
        ...
        YisLoger.logTagV(TAG,"process, offset: " + mSlideOffset);
        // relayout
        requestLayout();
    }
    ...
    private void finishTouchEvent() {
        ...
        YisLoger.logTag(TAG,"finish, offset: " + offset + ", percent: " + percent + ", yVelocity: " + yVelocity);
