package com.ycl.framework.utils.util.advanced;
 ...
 *
 *     https://github.com/Blankj/AndroidUtilCode  网址
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new CustomImageSpan(FrameApplication.getFrameContext(), bitmap, align), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new CustomImageSpan(FrameApplication.getFrameContext(), uri, align), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new CustomImageSpan(FrameApplication.getFrameContext(), resourceId, align), start, end, flag);
                    resourceId = 0;
