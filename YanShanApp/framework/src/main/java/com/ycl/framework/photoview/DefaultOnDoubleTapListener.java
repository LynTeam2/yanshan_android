 ...
 * <p>&nbsp;</p>
 * To be used via {@link com.ycl.framework.photoview.PhotoViewAttacher#setOnDoubleTapListener(GestureDetector.OnDoubleTapListener)}
 */
@SuppressLint("NewApi")
public class DefaultOnDoubleTapListener implements GestureDetector.OnDoubleTapListener {
    ...
    public boolean onDoubleTap(MotionEvent ev) {
        if (photoViewAttacher == null)
            return false;
        //重置单击  handler 回调tag
        photoViewAttacher.setDoubleTapTag(true);
        try {
