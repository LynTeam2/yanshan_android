...
public class RoundedRectProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(new RectF(0, this.getMeasuredHeight()/2, this.getMeasuredWidth(), this.getMeasuredHeight()), radius, radius, mPaint);
        //进度条
        mPaint.setColor(barColor);
        mPaint.setStyle(Paint.Style.FILL);
        canvas.drawRoundRect(new RectF(0, this.getMeasuredHeight()/2, this.getMeasuredWidth() * progress / 100f, this.getMeasuredHeight()), radius, radius, mPaint);
        //进度
        mPaint.setColor(textColor);
        mPaint.setTextSize(this.getMeasuredHeight() / 2.4f);
