...
public class Hourly {
    ...
    private String cloud;// : "8"
    private String cond_code ;//: "100"
    private String cond_txt;// : "晴"
    private String hum ;//: "84"
    private String pop;// : "0"
    private String pres ;//: "1018"
    private String time ;//: "2017-10-27 01:00"
    private String tmp;// : "8"
    private String wind_deg;// : "49"
    private String wind_dir;// : "东北风"
    private String wind_sc ;//: "微风"
    private String wind_spd ;//: "2"
