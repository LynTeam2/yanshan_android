...
public class LD_WaveView extends View {
    ...
    private int mBorderWidth=20;//边界宽度
    ...
    private void init() {
        ...
        mBorderPaint.setColor(Color.parseColor("#DDDADA"));
    ...
    private void getAttr(Context context, AttributeSet attrs, int defStyle) {
        ...
        mProgress = a.getInteger(R.styleable.LD_WaveView_wave_progress,0);
        a.recycle();
    }
...
//            canvas.drawCircle(mViewWidth / 2, mViewHeight / 2, mViewHeight / 2, circlePaint);
            ...
            canvas.drawCircle(mViewWidth/2,mViewHeight/2,mViewHeight/2-mBorderWidth/4 ,mBorderPaint);
        }else {
            /**
             * 绘制矩形边框
             */
