...
public class ClientVideoPlayer extends JCVideoPlayer {
    ...
    public void setSeekBarThum() {
        int width = AutoUtils.getPercentWidthSize(50);
        width = width >= 50 ? width : 50;
        Drawable drawable = getNewDrawable(R.drawable.icon_video_progress, width, width);
        progressBar.setThumb(drawable);
    }
    public BitmapDrawable getNewDrawable(int restId, int dstWidth, int dstHeight) {
        Bitmap Bmp = BitmapFactory.decodeResource(
                getContext().getResources(), restId);
    ...
    public void setUp(String url, int screen, Object... objects) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            fullscreenButton.setImageResource(R.drawable.icon_video_unfull);
            backButton.setVisibility(View.VISIBLE);
        } else if (currentScreen == SCREEN_LAYOUT_NORMAL
                || currentScreen == SCREEN_LAYOUT_LIST) {
            fullscreenButton.setImageResource(R.drawable.icon_video_full);
    ...
    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            startButton.setImageResource(R.drawable.icon_video_pause);
        } else if (currentState == CURRENT_STATE_ERROR) {
            startButton.setImageResource(R.drawable.icon_video_play);
        } else if (currentState == CURRENT_STATE_AUTO_COMPLETE) {
            startButton.setImageResource(R.drawable.icon_video_play);
        } else {
            startButton.setImageResource(R.drawable.icon_video_play);
